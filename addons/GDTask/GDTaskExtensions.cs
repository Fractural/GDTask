...
public static partial class GDTaskExtensions
{
    ...
    {
        private static readonly Action<object> _cancellationCallbackDelegate = CancellationCallback;
        ...
        public AttachExternalCancellationSource(GDTask task, CancellationToken cancellationToken)
        {
            ...
            _tokenRegistration = cancellationToken.RegisterWithoutCaptureExecutionContext(_cancellationCallbackDelegate, this);
            RunTask(task).Forget();
        }
    ...
    public static async GDTask Timeout(
        this GDTask task,
        TimeSpan timeout,
        DelayType delayType = DelayType.DeltaTime,
        PlayerLoopTiming timeoutCheckTiming = PlayerLoopTiming.Process,
    ...
    public static async GDTask<T> Timeout<T>(
        this GDTask<T> task,
        TimeSpan timeout,
        DelayType delayType = DelayType.DeltaTime,
        PlayerLoopTiming timeoutCheckTiming = PlayerLoopTiming.Process,
    ...
    /// </summary>
    public static async GDTask<bool> TimeoutWithoutException(
        this GDTask task,
        TimeSpan timeout,
        DelayType delayType = DelayType.DeltaTime,
        PlayerLoopTiming timeoutCheckTiming = PlayerLoopTiming.Process,
    ...
    /// </summary>
    public static async GDTask<(bool IsTimeout, T Result)> TimeoutWithoutException<T>(
        this GDTask<T> task,
        TimeSpan timeout,
        DelayType delayType = DelayType.DeltaTime,
        PlayerLoopTiming timeoutCheckTiming = PlayerLoopTiming.Process,
