...
public static class GDTaskStatusExtensions
{
    ...
    {
        return status is not GDTaskStatus.Pending;
    }
    ...
    {
        return status is GDTaskStatus.Succeeded;
    }
    ...
    {
        return status is GDTaskStatus.Canceled;
    }
    ...
    {
        return status is GDTaskStatus.Faulted;
    }
}
