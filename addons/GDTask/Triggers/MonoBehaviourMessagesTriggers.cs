...
#region FixedUpdate
    ...
    {
        GDTask FixedUpdateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncFixedUpdateHandler
    {
        GDTask IAsyncFixedUpdateHandler.FixedUpdateAsync()
        {
            core.Reset();
    ...
    public sealed class AsyncFixedUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask FixedUpdateAsync()
        {
            return ((IAsyncFixedUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).FixedUpdateAsync();
        }

        public GDTask FixedUpdateAsync(CancellationToken cancellationToken)
        {
...
#region LateUpdate
    ...
    {
        GDTask LateUpdateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncLateUpdateHandler
    {
        GDTask IAsyncLateUpdateHandler.LateUpdateAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncLateUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask LateUpdateAsync()
        {
            return ((IAsyncLateUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).LateUpdateAsync();
        }

        public GDTask LateUpdateAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorIK
    ...
    {
        GDTask<int> OnAnimatorIKAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorIKHandler
    {
        GDTask<int> IAsyncOnAnimatorIKHandler.OnAnimatorIKAsync()
        {
            core.Reset();
            return new GDTask<int>((IGDTaskSource<int>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAnimatorIKTrigger : AsyncTriggerBase<int>
    {
        ...
        public GDTask<int> OnAnimatorIKAsync()
        {
            return ((IAsyncOnAnimatorIKHandler)new AsyncTriggerHandler<int>(this, true)).OnAnimatorIKAsync();
        }

        public GDTask<int> OnAnimatorIKAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorMove
    ...
    {
        GDTask OnAnimatorMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorMoveHandler
    {
        GDTask IAsyncOnAnimatorMoveHandler.OnAnimatorMoveAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncAnimatorMoveTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnAnimatorMoveAsync()
        {
            return ((IAsyncOnAnimatorMoveHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnAnimatorMoveAsync();
        }

        public GDTask OnAnimatorMoveAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationFocus
    ...
    {
        GDTask<bool> OnApplicationFocusAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationFocusHandler
    {
        GDTask<bool> IAsyncOnApplicationFocusHandler.OnApplicationFocusAsync()
        {
            core.Reset();
            return new GDTask<bool>((IGDTaskSource<bool>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncApplicationFocusTrigger : AsyncTriggerBase<bool>
    {
        ...
        public GDTask<bool> OnApplicationFocusAsync()
        {
            return ((IAsyncOnApplicationFocusHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationFocusAsync();
        }

        public GDTask<bool> OnApplicationFocusAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationPause
    ...
    {
        GDTask<bool> OnApplicationPauseAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationPauseHandler
    {
        GDTask<bool> IAsyncOnApplicationPauseHandler.OnApplicationPauseAsync()
        {
            core.Reset();
            return new GDTask<bool>((IGDTaskSource<bool>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationPauseTrigger : AsyncTriggerBase<bool>
    {
        ...
        public GDTask<bool> OnApplicationPauseAsync()
        {
            return ((IAsyncOnApplicationPauseHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationPauseAsync();
        }

        public GDTask<bool> OnApplicationPauseAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationQuit
    ...
    {
        GDTask OnApplicationQuitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationQuitHandler
    {
        GDTask IAsyncOnApplicationQuitHandler.OnApplicationQuitAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationQuitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnApplicationQuitAsync()
        {
            return ((IAsyncOnApplicationQuitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnApplicationQuitAsync();
        }

        public GDTask OnApplicationQuitAsync(CancellationToken cancellationToken)
        {
...
#region AudioFilterRead
    ...
    {
        GDTask<(float[] data, int channels)> OnAudioFilterReadAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAudioFilterReadHandler
    {
        GDTask<(float[] data, int channels)> IAsyncOnAudioFilterReadHandler.OnAudioFilterReadAsync()
        {
            core.Reset();
            return new GDTask<(float[] data, int channels)>((IGDTaskSource<(float[] data, int channels)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAudioFilterReadTrigger : AsyncTriggerBase<(float[] data, int channels)>
    {
        ...
        public GDTask<(float[] data, int channels)> OnAudioFilterReadAsync()
        {
            return ((IAsyncOnAudioFilterReadHandler)new AsyncTriggerHandler<(float[] data, int channels)>(this, true)).OnAudioFilterReadAsync();
        }

        public GDTask<(float[] data, int channels)> OnAudioFilterReadAsync(CancellationToken cancellationToken)
        {
...
#region BecameInvisible
    ...
    {
        GDTask OnBecameInvisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameInvisibleHandler
    {
        GDTask IAsyncOnBecameInvisibleHandler.OnBecameInvisibleAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameInvisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnBecameInvisibleAsync()
        {
            return ((IAsyncOnBecameInvisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameInvisibleAsync();
        }

        public GDTask OnBecameInvisibleAsync(CancellationToken cancellationToken)
        {
...
#region BecameVisible
    ...
    {
        GDTask OnBecameVisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameVisibleHandler
    {
        GDTask IAsyncOnBecameVisibleHandler.OnBecameVisibleAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameVisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnBecameVisibleAsync()
        {
            return ((IAsyncOnBecameVisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameVisibleAsync();
        }

        public GDTask OnBecameVisibleAsync(CancellationToken cancellationToken)
        {
...
#region BeforeTransformParentChanged
    ...
    {
        GDTask OnBeforeTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeforeTransformParentChangedHandler
    {
        GDTask IAsyncOnBeforeTransformParentChangedHandler.OnBeforeTransformParentChangedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBeforeTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnBeforeTransformParentChangedAsync()
        {
        ...
        public GDTask OnBeforeTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region OnCanvasGroupChanged
    ...
    {
        GDTask OnCanvasGroupChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCanvasGroupChangedHandler
    {
        GDTask IAsyncOnCanvasGroupChangedHandler.OnCanvasGroupChangedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncOnCanvasGroupChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnCanvasGroupChangedAsync()
        {
            return ((IAsyncOnCanvasGroupChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnCanvasGroupChangedAsync();
        }

        public GDTask OnCanvasGroupChangedAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter
    ...
    {
        GDTask<Collision> OnCollisionEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnterHandler
    {
        GDTask<Collision> IAsyncOnCollisionEnterHandler.OnCollisionEnterAsync()
        {
            core.Reset();
            return new GDTask<Collision>((IGDTaskSource<Collision>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnterTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public GDTask<Collision> OnCollisionEnterAsync()
        {
            return ((IAsyncOnCollisionEnterHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionEnterAsync();
        }

        public GDTask<Collision> OnCollisionEnterAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter2D
    ...
    {
        GDTask<Collision2D> OnCollisionEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnter2DHandler
    {
        GDTask<Collision2D> IAsyncOnCollisionEnter2DHandler.OnCollisionEnter2DAsync()
        {
            core.Reset();
            return new GDTask<Collision2D>((IGDTaskSource<Collision2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnter2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public GDTask<Collision2D> OnCollisionEnter2DAsync()
        {
            return ((IAsyncOnCollisionEnter2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionEnter2DAsync();
        }

        public GDTask<Collision2D> OnCollisionEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit
    ...
    {
        GDTask<Collision> OnCollisionExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExitHandler
    {
        GDTask<Collision> IAsyncOnCollisionExitHandler.OnCollisionExitAsync()
        {
            core.Reset();
            return new GDTask<Collision>((IGDTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExitTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public GDTask<Collision> OnCollisionExitAsync()
        {
            return ((IAsyncOnCollisionExitHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionExitAsync();
        }

        public GDTask<Collision> OnCollisionExitAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit2D
    ...
    {
        GDTask<Collision2D> OnCollisionExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExit2DHandler
    {
        GDTask<Collision2D> IAsyncOnCollisionExit2DHandler.OnCollisionExit2DAsync()
        {
            core.Reset();
            return new GDTask<Collision2D>((IGDTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExit2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public GDTask<Collision2D> OnCollisionExit2DAsync()
        {
            return ((IAsyncOnCollisionExit2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionExit2DAsync();
        }

        public GDTask<Collision2D> OnCollisionExit2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay
    ...
    {
        GDTask<Collision> OnCollisionStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStayHandler
    {
        GDTask<Collision> IAsyncOnCollisionStayHandler.OnCollisionStayAsync()
        {
            core.Reset();
            return new GDTask<Collision>((IGDTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStayTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public GDTask<Collision> OnCollisionStayAsync()
        {
            return ((IAsyncOnCollisionStayHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionStayAsync();
        }

        public GDTask<Collision> OnCollisionStayAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay2D
    ...
    {
        GDTask<Collision2D> OnCollisionStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStay2DHandler
    {
        GDTask<Collision2D> IAsyncOnCollisionStay2DHandler.OnCollisionStay2DAsync()
        {
            core.Reset();
            return new GDTask<Collision2D>((IGDTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStay2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public GDTask<Collision2D> OnCollisionStay2DAsync()
        {
            return ((IAsyncOnCollisionStay2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionStay2DAsync();
        }

        public GDTask<Collision2D> OnCollisionStay2DAsync(CancellationToken cancellationToken)
        {
...
#region ControllerColliderHit
    ...
    {
        GDTask<ControllerColliderHit> OnControllerColliderHitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnControllerColliderHitHandler
    {
        GDTask<ControllerColliderHit> IAsyncOnControllerColliderHitHandler.OnControllerColliderHitAsync()
        {
            core.Reset();
            return new GDTask<ControllerColliderHit>((IGDTaskSource<ControllerColliderHit>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncControllerColliderHitTrigger : AsyncTriggerBase<ControllerColliderHit>
    {
        ...
        public GDTask<ControllerColliderHit> OnControllerColliderHitAsync()
        {
        ...
        public GDTask<ControllerColliderHit> OnControllerColliderHitAsync(CancellationToken cancellationToken)
        {
...
#region Disable
    ...
    {
        GDTask OnDisableAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDisableHandler
    {
        GDTask IAsyncOnDisableHandler.OnDisableAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDisableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnDisableAsync()
        {
            return ((IAsyncOnDisableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDisableAsync();
        }

        public GDTask OnDisableAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmos
    ...
    {
        GDTask OnDrawGizmosAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosHandler
    {
        GDTask IAsyncOnDrawGizmosHandler.OnDrawGizmosAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnDrawGizmosAsync()
        {
            return ((IAsyncOnDrawGizmosHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosAsync();
        }

        public GDTask OnDrawGizmosAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmosSelected
    ...
    {
        GDTask OnDrawGizmosSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosSelectedHandler
    {
        GDTask IAsyncOnDrawGizmosSelectedHandler.OnDrawGizmosSelectedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosSelectedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnDrawGizmosSelectedAsync()
        {
            return ((IAsyncOnDrawGizmosSelectedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosSelectedAsync();
        }

        public GDTask OnDrawGizmosSelectedAsync(CancellationToken cancellationToken)
        {
...
#region Enable
    ...
    public sealed class AsyncEnableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnEnableAsync()
        {
            return ((IAsyncOnEnableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnEnableAsync();
        }

        public GDTask OnEnableAsync(CancellationToken cancellationToken)
        {
...
#region GUI
    ...
    {
        GDTask IAsyncOnGUIHandler.OnGUIAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncGUITrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnGUIAsync()
        {
            return ((IAsyncOnGUIHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnGUIAsync();
        }

        public GDTask OnGUIAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak
    ...
    {
        GDTask<float> OnJointBreakAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreakHandler
    {
        GDTask<float> IAsyncOnJointBreakHandler.OnJointBreakAsync()
        {
            core.Reset();
            return new GDTask<float>((IGDTaskSource<float>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreakTrigger : AsyncTriggerBase<float>
    {
        ...
        public GDTask<float> OnJointBreakAsync()
        {
            return ((IAsyncOnJointBreakHandler)new AsyncTriggerHandler<float>(this, true)).OnJointBreakAsync();
        }

        public GDTask<float> OnJointBreakAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak2D
    ...
    {
        GDTask<Joint2D> OnJointBreak2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreak2DHandler
    {
        GDTask<Joint2D> IAsyncOnJointBreak2DHandler.OnJointBreak2DAsync()
        {
            core.Reset();
            return new GDTask<Joint2D>((IGDTaskSource<Joint2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreak2DTrigger : AsyncTriggerBase<Joint2D>
    {
        ...
        public GDTask<Joint2D> OnJointBreak2DAsync()
        {
            return ((IAsyncOnJointBreak2DHandler)new AsyncTriggerHandler<Joint2D>(this, true)).OnJointBreak2DAsync();
        }

        public GDTask<Joint2D> OnJointBreak2DAsync(CancellationToken cancellationToken)
        {
...
#region MouseDown
    ...
    {
        GDTask OnMouseDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDownHandler
    {
        GDTask IAsyncOnMouseDownHandler.OnMouseDownAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDownTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseDownAsync()
        {
            return ((IAsyncOnMouseDownHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDownAsync();
        }

        public GDTask OnMouseDownAsync(CancellationToken cancellationToken)
        {
...
#region MouseDrag
    ...
    {
        GDTask OnMouseDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDragHandler
    {
        GDTask IAsyncOnMouseDragHandler.OnMouseDragAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDragTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseDragAsync()
        {
            return ((IAsyncOnMouseDragHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDragAsync();
        }

        public GDTask OnMouseDragAsync(CancellationToken cancellationToken)
        {
...
#region MouseEnter
    ...
    {
        GDTask OnMouseEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseEnterHandler
    {
        GDTask IAsyncOnMouseEnterHandler.OnMouseEnterAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseEnterTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseEnterAsync()
        {
            return ((IAsyncOnMouseEnterHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseEnterAsync();
        }

        public GDTask OnMouseEnterAsync(CancellationToken cancellationToken)
        {
...
#region MouseExit
    ...
    {
        GDTask OnMouseExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseExitHandler
    {
        GDTask IAsyncOnMouseExitHandler.OnMouseExitAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseExitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseExitAsync()
        {
            return ((IAsyncOnMouseExitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseExitAsync();
        }

        public GDTask OnMouseExitAsync(CancellationToken cancellationToken)
        {
...
#region MouseOver
    ...
    {
        GDTask OnMouseOverAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseOverHandler
    {
        GDTask IAsyncOnMouseOverHandler.OnMouseOverAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseOverTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseOverAsync()
        {
            return ((IAsyncOnMouseOverHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseOverAsync();
        }

        public GDTask OnMouseOverAsync(CancellationToken cancellationToken)
        {
...
#region MouseUp
    ...
    {
        GDTask OnMouseUpAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseUpHandler
    {
        GDTask IAsyncOnMouseUpHandler.OnMouseUpAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseUpAsync()
        {
            return ((IAsyncOnMouseUpHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsync();
        }

        public GDTask OnMouseUpAsync(CancellationToken cancellationToken)
        {
...
#region MouseUpAsButton
    ...
    {
        GDTask OnMouseUpAsButtonAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseUpAsButtonHandler
    {
        GDTask IAsyncOnMouseUpAsButtonHandler.OnMouseUpAsButtonAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpAsButtonTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnMouseUpAsButtonAsync()
        {
            return ((IAsyncOnMouseUpAsButtonHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsButtonAsync();
        }

        public GDTask OnMouseUpAsButtonAsync(CancellationToken cancellationToken)
        {
...
#region ParticleCollision
    ...
    {
        GDTask<GameObject> OnParticleCollisionAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleCollisionHandler
    {
        GDTask<GameObject> IAsyncOnParticleCollisionHandler.OnParticleCollisionAsync()
        {
            core.Reset();
            return new GDTask<GameObject>((IGDTaskSource<GameObject>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleCollisionTrigger : AsyncTriggerBase<GameObject>
    {
        ...
        public GDTask<GameObject> OnParticleCollisionAsync()
        {
            return ((IAsyncOnParticleCollisionHandler)new AsyncTriggerHandler<GameObject>(this, true)).OnParticleCollisionAsync();
        }

        public GDTask<GameObject> OnParticleCollisionAsync(CancellationToken cancellationToken)
        {
...
#region ParticleSystemStopped
    ...
    {
        GDTask OnParticleSystemStoppedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleSystemStoppedHandler
    {
        GDTask IAsyncOnParticleSystemStoppedHandler.OnParticleSystemStoppedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleSystemStoppedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnParticleSystemStoppedAsync()
        {
            return ((IAsyncOnParticleSystemStoppedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleSystemStoppedAsync();
        }

        public GDTask OnParticleSystemStoppedAsync(CancellationToken cancellationToken)
        {
...
#region ParticleTrigger
    ...
    {
        GDTask OnParticleTriggerAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleTriggerHandler
    {
        GDTask IAsyncOnParticleTriggerHandler.OnParticleTriggerAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleTriggerTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnParticleTriggerAsync()
        {
            return ((IAsyncOnParticleTriggerHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleTriggerAsync();
        }

        public GDTask OnParticleTriggerAsync(CancellationToken cancellationToken)
        {
...
#region ParticleUpdateJobScheduled
    ...
    {
        GDTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleUpdateJobScheduledHandler
    {
        GDTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> IAsyncOnParticleUpdateJobScheduledHandler.OnParticleUpdateJobScheduledAsync()
        {
            core.Reset();
            return new GDTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>((IGDTaskSource<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleUpdateJobScheduledTrigger : AsyncTriggerBase<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
    {
        ...
        public GDTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync()
        {
        ...
        public GDTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync(CancellationToken cancellationToken)
        {
...
#region PostRender
    ...
    {
        GDTask OnPostRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPostRenderHandler
    {
        GDTask IAsyncOnPostRenderHandler.OnPostRenderAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPostRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnPostRenderAsync()
        {
            return ((IAsyncOnPostRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPostRenderAsync();
        }

        public GDTask OnPostRenderAsync(CancellationToken cancellationToken)
        {
...
#region PreCull
    ...
    {
        GDTask OnPreCullAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPreCullHandler
    {
        GDTask IAsyncOnPreCullHandler.OnPreCullAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreCullTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnPreCullAsync()
        {
            return ((IAsyncOnPreCullHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreCullAsync();
        }

        public GDTask OnPreCullAsync(CancellationToken cancellationToken)
        {
...
#region PreRender
    ...
    {
        GDTask OnPreRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPreRenderHandler
    {
        GDTask IAsyncOnPreRenderHandler.OnPreRenderAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnPreRenderAsync()
        {
            return ((IAsyncOnPreRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreRenderAsync();
        }

        public GDTask OnPreRenderAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformDimensionsChange
    ...
    {
        GDTask OnRectTransformDimensionsChangeAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformDimensionsChangeHandler
    {
        GDTask IAsyncOnRectTransformDimensionsChangeHandler.OnRectTransformDimensionsChangeAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformDimensionsChangeTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnRectTransformDimensionsChangeAsync()
        {
        ...
        public GDTask OnRectTransformDimensionsChangeAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformRemoved
    ...
    {
        GDTask OnRectTransformRemovedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformRemovedHandler
    {
        GDTask IAsyncOnRectTransformRemovedHandler.OnRectTransformRemovedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformRemovedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnRectTransformRemovedAsync()
        {
            return ((IAsyncOnRectTransformRemovedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRectTransformRemovedAsync();
        }

        public GDTask OnRectTransformRemovedAsync(CancellationToken cancellationToken)
        {
...
#region RenderImage
    ...
    {
        GDTask<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderImageHandler
    {
        GDTask<(RenderTexture source, RenderTexture destination)> IAsyncOnRenderImageHandler.OnRenderImageAsync()
        {
            core.Reset();
            return new GDTask<(RenderTexture source, RenderTexture destination)>((IGDTaskSource<(RenderTexture source, RenderTexture destination)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncRenderImageTrigger : AsyncTriggerBase<(RenderTexture source, RenderTexture destination)>
    {
        ...
        public GDTask<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync()
        {
        ...
        public GDTask<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync(CancellationToken cancellationToken)
        {
...
#region RenderObject
    ...
    {
        GDTask OnRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderObjectHandler
    {
        GDTask IAsyncOnRenderObjectHandler.OnRenderObjectAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnRenderObjectAsync()
        {
            return ((IAsyncOnRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRenderObjectAsync();
        }

        public GDTask OnRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region ServerInitialized
    ...
    {
        GDTask OnServerInitializedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnServerInitializedHandler
    {
        GDTask IAsyncOnServerInitializedHandler.OnServerInitializedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncServerInitializedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnServerInitializedAsync()
        {
            return ((IAsyncOnServerInitializedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnServerInitializedAsync();
        }

        public GDTask OnServerInitializedAsync(CancellationToken cancellationToken)
        {
...
#region TransformChildrenChanged
    ...
    {
        GDTask OnTransformChildrenChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformChildrenChangedHandler
    {
        GDTask IAsyncOnTransformChildrenChangedHandler.OnTransformChildrenChangedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformChildrenChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnTransformChildrenChangedAsync()
        {
        ...
        public GDTask OnTransformChildrenChangedAsync(CancellationToken cancellationToken)
        {
...
#region TransformParentChanged
    ...
    {
        GDTask OnTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformParentChangedHandler
    {
        GDTask IAsyncOnTransformParentChangedHandler.OnTransformParentChangedAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnTransformParentChangedAsync()
        {
            return ((IAsyncOnTransformParentChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnTransformParentChangedAsync();
        }

        public GDTask OnTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter
    ...
    {
        GDTask<Collider> OnTriggerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnterHandler
    {
        GDTask<Collider> IAsyncOnTriggerEnterHandler.OnTriggerEnterAsync()
        {
            core.Reset();
            return new GDTask<Collider>((IGDTaskSource<Collider>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnterTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public GDTask<Collider> OnTriggerEnterAsync()
        {
            return ((IAsyncOnTriggerEnterHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerEnterAsync();
        }

        public GDTask<Collider> OnTriggerEnterAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter2D
    ...
    {
        GDTask<Collider2D> OnTriggerEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnter2DHandler
    {
        GDTask<Collider2D> IAsyncOnTriggerEnter2DHandler.OnTriggerEnter2DAsync()
        {
            core.Reset();
            return new GDTask<Collider2D>((IGDTaskSource<Collider2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnter2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public GDTask<Collider2D> OnTriggerEnter2DAsync()
        {
            return ((IAsyncOnTriggerEnter2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerEnter2DAsync();
        }

        public GDTask<Collider2D> OnTriggerEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit
    ...
    {
        GDTask<Collider> OnTriggerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExitHandler
    {
        GDTask<Collider> IAsyncOnTriggerExitHandler.OnTriggerExitAsync()
        {
            core.Reset();
            return new GDTask<Collider>((IGDTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExitTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public GDTask<Collider> OnTriggerExitAsync()
        {
            return ((IAsyncOnTriggerExitHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerExitAsync();
        }

        public GDTask<Collider> OnTriggerExitAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit2D
    ...
    {
        GDTask<Collider2D> OnTriggerExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExit2DHandler
    {
        GDTask<Collider2D> IAsyncOnTriggerExit2DHandler.OnTriggerExit2DAsync()
        {
            core.Reset();
            return new GDTask<Collider2D>((IGDTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExit2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public GDTask<Collider2D> OnTriggerExit2DAsync()
        {
            return ((IAsyncOnTriggerExit2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerExit2DAsync();
        }

        public GDTask<Collider2D> OnTriggerExit2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay
    ...
    {
        GDTask<Collider> OnTriggerStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStayHandler
    {
        GDTask<Collider> IAsyncOnTriggerStayHandler.OnTriggerStayAsync()
        {
            core.Reset();
            return new GDTask<Collider>((IGDTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStayTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public GDTask<Collider> OnTriggerStayAsync()
        {
            return ((IAsyncOnTriggerStayHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerStayAsync();
        }

        public GDTask<Collider> OnTriggerStayAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay2D
    ...
    {
        GDTask<Collider2D> OnTriggerStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStay2DHandler
    {
        GDTask<Collider2D> IAsyncOnTriggerStay2DHandler.OnTriggerStay2DAsync()
        {
            core.Reset();
            return new GDTask<Collider2D>((IGDTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStay2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public GDTask<Collider2D> OnTriggerStay2DAsync()
        {
            return ((IAsyncOnTriggerStay2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerStay2DAsync();
        }

        public GDTask<Collider2D> OnTriggerStay2DAsync(CancellationToken cancellationToken)
        {
...
#region Validate
    ...
    {
        GDTask OnValidateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnValidateHandler
    {
        GDTask IAsyncOnValidateHandler.OnValidateAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncValidateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnValidateAsync()
        {
            return ((IAsyncOnValidateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnValidateAsync();
        }

        public GDTask OnValidateAsync(CancellationToken cancellationToken)
        {
...
#region WillRenderObject
    ...
    {
        GDTask OnWillRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnWillRenderObjectHandler
    {
        GDTask IAsyncOnWillRenderObjectHandler.OnWillRenderObjectAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncWillRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask OnWillRenderObjectAsync()
        {
            return ((IAsyncOnWillRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnWillRenderObjectAsync();
        }

        public GDTask OnWillRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region Reset
    ...
    {
        GDTask IAsyncResetHandler.ResetAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncResetTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask ResetAsync()
        {
            return ((IAsyncResetHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).ResetAsync();
        }

        public GDTask ResetAsync(CancellationToken cancellationToken)
        {
...
#region Update
    ...
    {
        GDTask IAsyncUpdateHandler.UpdateAsync()
        {
            core.Reset();
            return new GDTask((IGDTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public GDTask UpdateAsync()
        {
            return ((IAsyncUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).UpdateAsync();
        }

        public GDTask UpdateAsync(CancellationToken cancellationToken)
        {
...
#region BeginDrag
    ...
    {
        GDTask<PointerEventData> OnBeginDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeginDragHandler
    {
        GDTask<PointerEventData> IAsyncOnBeginDragHandler.OnBeginDragAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncBeginDragTrigger : AsyncTriggerBase<PointerEventData>, IBeginDragHandler
    {
        ...
        public GDTask<PointerEventData> OnBeginDragAsync()
        {
            return ((IAsyncOnBeginDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnBeginDragAsync();
        }

        public GDTask<PointerEventData> OnBeginDragAsync(CancellationToken cancellationToken)
        {
...
#region Cancel
    ...
    {
        GDTask<BaseEventData> OnCancelAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCancelHandler
    {
        GDTask<BaseEventData> IAsyncOnCancelHandler.OnCancelAsync()
        {
            core.Reset();
            return new GDTask<BaseEventData>((IGDTaskSource<BaseEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCancelTrigger : AsyncTriggerBase<BaseEventData>, ICancelHandler
    {
        ...
        public GDTask<BaseEventData> OnCancelAsync()
        {
            return ((IAsyncOnCancelHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnCancelAsync();
        }

        public GDTask<BaseEventData> OnCancelAsync(CancellationToken cancellationToken)
        {
...
#region Deselect
    ...
    {
        GDTask<BaseEventData> OnDeselectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDeselectHandler
    {
        GDTask<BaseEventData> IAsyncOnDeselectHandler.OnDeselectAsync()
        {
            core.Reset();
            return new GDTask<BaseEventData>((IGDTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDeselectTrigger : AsyncTriggerBase<BaseEventData>, IDeselectHandler
    {
        ...
        public GDTask<BaseEventData> OnDeselectAsync()
        {
            return ((IAsyncOnDeselectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnDeselectAsync();
        }

        public GDTask<BaseEventData> OnDeselectAsync(CancellationToken cancellationToken)
        {
...
#region Drag
    ...
    {
        GDTask<PointerEventData> OnDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDragHandler
    {
        GDTask<PointerEventData> IAsyncOnDragHandler.OnDragAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDragTrigger : AsyncTriggerBase<PointerEventData>, IDragHandler
    {
        ...
        public GDTask<PointerEventData> OnDragAsync()
        {
            return ((IAsyncOnDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDragAsync();
        }

        public GDTask<PointerEventData> OnDragAsync(CancellationToken cancellationToken)
        {
...
#region Drop
    ...
    {
        GDTask<PointerEventData> OnDropAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDropHandler
    {
        GDTask<PointerEventData> IAsyncOnDropHandler.OnDropAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDropTrigger : AsyncTriggerBase<PointerEventData>, IDropHandler
    {
        ...
        public GDTask<PointerEventData> OnDropAsync()
        {
            return ((IAsyncOnDropHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDropAsync();
        }

        public GDTask<PointerEventData> OnDropAsync(CancellationToken cancellationToken)
        {
...
#region EndDrag
    ...
    {
        GDTask<PointerEventData> OnEndDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnEndDragHandler
    {
        GDTask<PointerEventData> IAsyncOnEndDragHandler.OnEndDragAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncEndDragTrigger : AsyncTriggerBase<PointerEventData>, IEndDragHandler
    {
        ...
        public GDTask<PointerEventData> OnEndDragAsync()
        {
            return ((IAsyncOnEndDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnEndDragAsync();
        }

        public GDTask<PointerEventData> OnEndDragAsync(CancellationToken cancellationToken)
        {
...
#region InitializePotentialDrag
    ...
    {
        GDTask<PointerEventData> OnInitializePotentialDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnInitializePotentialDragHandler
    {
        GDTask<PointerEventData> IAsyncOnInitializePotentialDragHandler.OnInitializePotentialDragAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncInitializePotentialDragTrigger : AsyncTriggerBase<PointerEventData>, IInitializePotentialDragHandler
    {
        ...
        public GDTask<PointerEventData> OnInitializePotentialDragAsync()
        {
        ...
        public GDTask<PointerEventData> OnInitializePotentialDragAsync(CancellationToken cancellationToken)
        {
...
#region Move
    ...
    {
        GDTask<AxisEventData> OnMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMoveHandler
    {
        GDTask<AxisEventData> IAsyncOnMoveHandler.OnMoveAsync()
        {
            core.Reset();
            return new GDTask<AxisEventData>((IGDTaskSource<AxisEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncMoveTrigger : AsyncTriggerBase<AxisEventData>, IMoveHandler
    {
        ...
        public GDTask<AxisEventData> OnMoveAsync()
        {
            return ((IAsyncOnMoveHandler)new AsyncTriggerHandler<AxisEventData>(this, true)).OnMoveAsync();
        }

        public GDTask<AxisEventData> OnMoveAsync(CancellationToken cancellationToken)
        {
...
#region PointerClick
    ...
    {
        GDTask<PointerEventData> OnPointerClickAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerClickHandler
    {
        GDTask<PointerEventData> IAsyncOnPointerClickHandler.OnPointerClickAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerClickTrigger : AsyncTriggerBase<PointerEventData>, IPointerClickHandler
    {
        ...
        public GDTask<PointerEventData> OnPointerClickAsync()
        {
            return ((IAsyncOnPointerClickHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerClickAsync();
        }

        public GDTask<PointerEventData> OnPointerClickAsync(CancellationToken cancellationToken)
        {
...
#region PointerDown
    ...
    {
        GDTask<PointerEventData> OnPointerDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerDownHandler
    {
        GDTask<PointerEventData> IAsyncOnPointerDownHandler.OnPointerDownAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerDownTrigger : AsyncTriggerBase<PointerEventData>, IPointerDownHandler
    {
        ...
        public GDTask<PointerEventData> OnPointerDownAsync()
        {
            return ((IAsyncOnPointerDownHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerDownAsync();
        }

        public GDTask<PointerEventData> OnPointerDownAsync(CancellationToken cancellationToken)
        {
...
#region PointerEnter
    ...
    {
        GDTask<PointerEventData> OnPointerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerEnterHandler
    {
        GDTask<PointerEventData> IAsyncOnPointerEnterHandler.OnPointerEnterAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerEnterTrigger : AsyncTriggerBase<PointerEventData>, IPointerEnterHandler
    {
        ...
        public GDTask<PointerEventData> OnPointerEnterAsync()
        {
            return ((IAsyncOnPointerEnterHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerEnterAsync();
        }

        public GDTask<PointerEventData> OnPointerEnterAsync(CancellationToken cancellationToken)
        {
...
#region PointerExit
    ...
    {
        GDTask<PointerEventData> OnPointerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerExitHandler
    {
        GDTask<PointerEventData> IAsyncOnPointerExitHandler.OnPointerExitAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerExitTrigger : AsyncTriggerBase<PointerEventData>, IPointerExitHandler
    {
        ...
        public GDTask<PointerEventData> OnPointerExitAsync()
        {
            return ((IAsyncOnPointerExitHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerExitAsync();
        }

        public GDTask<PointerEventData> OnPointerExitAsync(CancellationToken cancellationToken)
        {
...
#region PointerUp
    ...
    {
        GDTask<PointerEventData> OnPointerUpAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerUpHandler
    {
        GDTask<PointerEventData> IAsyncOnPointerUpHandler.OnPointerUpAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerUpTrigger : AsyncTriggerBase<PointerEventData>, IPointerUpHandler
    {
        ...
        public GDTask<PointerEventData> OnPointerUpAsync()
        {
            return ((IAsyncOnPointerUpHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerUpAsync();
        }

        public GDTask<PointerEventData> OnPointerUpAsync(CancellationToken cancellationToken)
        {
...
#region Scroll
    ...
    {
        GDTask<PointerEventData> OnScrollAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnScrollHandler
    {
        GDTask<PointerEventData> IAsyncOnScrollHandler.OnScrollAsync()
        {
            core.Reset();
            return new GDTask<PointerEventData>((IGDTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncScrollTrigger : AsyncTriggerBase<PointerEventData>, IScrollHandler
    {
        ...
        public GDTask<PointerEventData> OnScrollAsync()
        {
            return ((IAsyncOnScrollHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnScrollAsync();
        }

        public GDTask<PointerEventData> OnScrollAsync(CancellationToken cancellationToken)
        {
...
#region Select
    ...
    {
        GDTask<BaseEventData> OnSelectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSelectHandler
    {
        GDTask<BaseEventData> IAsyncOnSelectHandler.OnSelectAsync()
        {
            core.Reset();
            return new GDTask<BaseEventData>((IGDTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSelectTrigger : AsyncTriggerBase<BaseEventData>, ISelectHandler
    {
        ...
        public GDTask<BaseEventData> OnSelectAsync()
        {
            return ((IAsyncOnSelectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSelectAsync();
        }

        public GDTask<BaseEventData> OnSelectAsync(CancellationToken cancellationToken)
        {
...
#region Submit
    ...
    {
        GDTask<BaseEventData> OnSubmitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSubmitHandler
    {
        GDTask<BaseEventData> IAsyncOnSubmitHandler.OnSubmitAsync()
        {
            core.Reset();
            return new GDTask<BaseEventData>((IGDTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSubmitTrigger : AsyncTriggerBase<BaseEventData>, ISubmitHandler
    {
        ...
        public GDTask<BaseEventData> OnSubmitAsync()
        {
            return ((IAsyncOnSubmitHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSubmitAsync();
        }

        public GDTask<BaseEventData> OnSubmitAsync(CancellationToken cancellationToken)
        {
...
#region UpdateSelected
    ...
    {
        GDTask<BaseEventData> OnUpdateSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnUpdateSelectedHandler
    {
        GDTask<BaseEventData> IAsyncOnUpdateSelectedHandler.OnUpdateSelectedAsync()
        {
            core.Reset();
            return new GDTask<BaseEventData>((IGDTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateSelectedTrigger : AsyncTriggerBase<BaseEventData>, IUpdateSelectedHandler
    {
        ...
        public GDTask<BaseEventData> OnUpdateSelectedAsync()
        {
            return ((IAsyncOnUpdateSelectedHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnUpdateSelectedAsync();
        }

        public GDTask<BaseEventData> OnUpdateSelectedAsync(CancellationToken cancellationToken)
        {
